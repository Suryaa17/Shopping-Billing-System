    ...
    {  
        public static void main(String args[])   
            {  
                ...
                System.out.println("\t\t\t\t\t "+"  "+"       Suryaa Market");  
                System.out.println("\t\t\t\t\t      Agaram Road, Selaiyur");  
                System.out.println("\t\t\t\t\t" +"     Near Bharath University");  
                System.out.println("GSTIN: 03AWBPP8756K592"+"\t\t\t\t\t\t\tContact: +91 6385711708");  
